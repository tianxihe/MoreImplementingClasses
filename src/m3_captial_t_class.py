...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        What comes in:
           ...
           -- a int for the width of the CapitalT (the width of the
        ...
        """
        P1=rg.Point(intersection_center.x-width/2,
                    intersection_center.y+letter_thickness/2)
        P2=rg.Point(intersection_center.x+width/2,
                    intersection_center.y-letter_thickness/2)
        self.h_rect=rg.Rectangle(P1,P2)
        P3=rg.Point(intersection_center.x-letter_thickness/2,
                    intersection_center.y-letter_thickness/2)
        P4=rg.Point(intersection_center.x+letter_thickness/2,
